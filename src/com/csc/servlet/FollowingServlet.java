...
public class FollowingServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		Vector<PersonBean> ve = new Follow().getfollowing(pbLog, "current");
		...
		for (int i = 0; i < ve.size();) {
			if ((ve.elementAt(i).getFullName() == null)
				...
				session.setAttribute("followingOfCurrent", ve);
				break;
			}

		}
		RequestDispatcher rqdis = request.getRequestDispatcher("Following.jsp");
